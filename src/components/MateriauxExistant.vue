...
export default {
  ...
  methods: {
    ...
    // ✅ Import Excel sans effacement + anti-doublon
    async importerExcel(event) {
      ...
      for (const row of jsonData) {
        ...
        // Vérifie si ce matériau existe déjà
      ...
      if (nouveaux.length) {
        ...
        console.log(`${nouveaux.length} nouveaux matériaux ajoutés.`);
      } else {
        console.log("Aucun nouveau matériau à ajouter.");
      }
