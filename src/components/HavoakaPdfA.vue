            ...
            <tr style="background-color: rgb(79, 106, 136);color: white;">
              ...
              <tr v-for="Anjara in MikarokaAnarana" v-bind:key="Anjara.idAnjara">
                  ...
                  <td class="toerana" style="font-size: 21px;">
                    ...
                    <!-- <div v-if='formatDateJour(Anjara.Daty) != "Alahady"' >{{formatDate(Anjara.Daty)}}</div>
                    <div v-if='formatDateJour(Anjara.Daty) == "Alahady"'>{{formatDate(Anjara.Daty)}}<div>FIVORIAMBEN'NY VONDROM-PARITRA</div></div> -->
                    <div v-if='formatJour(Anjara.Daty) == "27"'>FIVORIAMBEN'NY VONDROM-PARITRA</div>
                  ...
                  <td class="toerana">
                    ...
                    <div v-if='formatDateJour(Anjara.Daty) == "Alahady"' style="font-size: 21px;">
                      ...
                      <b style="float: left;margin-left: 40px;" v-if='formatJour(Anjara.Daty) != "27"'>{{Anjara.Anarana1}} & {{Anjara.Anarana2}}</b>
                      <b style="float: right;" v-if='formatJour(Anjara.Daty) != "27"'>  {{Anjara.Anarana3}} & {{Anjara.Anarana4}}</b>
                      <b v-if='formatJour(Anjara.Daty) == "27"'>Tsy misy</b>  
...
genererPdf() {
  ...
  const fivoriambe = "FIVORIAMBEN'NY VONDROM-PARITRA";
