  ...
  <div class="container py-5">
    ...
    <!-- <div class="card shadow-sm mb-5">
      <div class="card-body">
        ...
        <form @submit.prevent="ajouterMainOeuvre()" class="row g-3 align-items-end">

          <div class="col-md-4">
            <label class="form-label fw-semibold">Nom</label>
            <input v-model="nom" type="text" class="form-control form-control-lg modern-input" placeholder="Nom catégorie" required />
          </div>

          <div class="col-md-4">
            <label class="form-label fw-semibold">Salaire de base</label>
            <input v-model="SalaireBase" class="form-control form-control-lg modern-input" placeholder="Ex: 100000" required />
          </div>

          <div class="col-md-4">
            <label class="form-label fw-semibold">Heures de base</label>
            <input v-model="HeureBase" type="number" class="form-control form-control-lg modern-input" placeholder="Ex: 8" required />
          </div>

          <div class="col-12 text-end mt-3">
            <button type="submit" class="btn btn-success btn-lg rounded-pill shadow-sm hover-grow">
    ...
    <v-expansion-panels>
      ...
      <v-expansion-panel>
        <v-expansion-panel-title style="font-size: 20px;">Nouveau Main d'oeuvre</v-expansion-panel-title>
