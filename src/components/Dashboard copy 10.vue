...
export default {
  ...
  methods: {
    async sendMessage() {
      ...
      // ✅ Prompt BTP + mise en gras uniquement des titres demandés
      const botPrompt = `
...
vous devez donner une réponse structurée comme ceci :
...
- Répondre directement avec les informations techniques.
- Utiliser les balises <b>...</b> uniquement pour les deux titres demandés.
`;
