...
<sdp
  ...
  :bde-avec-travaux="bdeAvecTravaux"
  @nouvelle-designation="modaleNouvelleDesignation"
/>
  <!-- Toast notification -->
...
<div v-if="numeroBdeSelectionne" class="mt-2">
  <strong>Numéro BDE :</strong> {{ numeroBdeSelectionne }}
</div>
...
<script>
import sdp from '@/components/ChildA.vue'
...
import autoTable from "jspdf-autotable";
  import db from '@/db';
  export default {
    components: { multiselect,sdp },
    data() {
      return {
        numeroBdeSelectionne: null,
        chargement:true,
...
getNumeroBde(designation) {
    ...
    this.numeroBdeSelectionne = this.getNumeroBde(designation);
  },
      // FILTER PROJET
