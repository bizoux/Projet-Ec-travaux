        ...
        <tr style="background-color: rgb(79, 106, 136);color: white;">
          ...
          <tr v-for="Anjara in MikarokaAnarana" v-bind:key="Anjara.idAnjara">
              ...
              <td class="toerana" style="font-size: 21px;">
                <div v-if='formatDateJour(Anjara.Daty) != "Talata"' >{{formatDate(Anjara.Daty)}}</div>
                <div v-if='formatDateJour(Anjara.Daty) == "Talata"'>{{formatDate(Anjara.Daty)}}<div>Fitsidihan'ny Mpiandraikitra ny Faritra</div></div>
                <div v-if='formatJour(Anjara.Daty) == "6"'>Lahatenin'ny Mpiandraikitra ny Faritra</div>
              </td>
              ...
              <td class="toerana">
                <div v-if='formatDateJour(Anjara.Daty) == "Alahady"' style="font-size: 21px;">
                  ...
                  <div v-if='formatJour(Anjara.Daty) == "30"'>
                    formatJour
                  </div> -->

                  <b style="float: left;" v-if='formatJour(Anjara.Daty) != "30"'>09:45</b>
                  <b style="float: left;margin-left: 40px;" v-if='formatJour(Anjara.Daty) != "30"'>{{Anjara.Anarana1}} & {{Anjara.Anarana2}}</b>
                  <b style="float: right;" v-if='formatJour(Anjara.Daty) != "30"'>  {{Anjara.Anarana3}} & {{Anjara.Anarana4}}</b>
                  <b v-if='formatJour(Anjara.Daty) == "30"'>Tsy misy</b>
                ...
                <div v-else-if='formatDateJour(Anjara.Daty) == "Talata"' style="font-size: 21px;color:rgba(40,127,186);">
...
genererPdf() {
  ...
  const texte = "Tsy misy"; 
  const fitsidihana = "Fitsidihan'ny Mpiandraikitra ny Faritra";
  const lahateny = "Lahatenin'ny Mpiandraikitra ny Faritra";
