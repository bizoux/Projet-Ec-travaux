...
<div class="card shadow-sm p-4 mb-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="mb-0">Gestion des Travaux</h5>
    <div class="d-flex gap-2">
      <button class="btn btn-primary d-flex align-items-center gap-2" @click="modaleNouveauTravaux">
        <font-awesome-icon icon="hammer" />
        <span>Nouveau</span>
      </button>

      <button class="btn btn-outline-primary d-flex align-items-center gap-2" @click="modaleBde">
  ...
  <div v-if="ProjetList.length > 0" class="mb-3">
    <label for="selectProjet" class="form-label fw-semibold">Projet</label>
    <select
      id="selectProjet"
...
<form @submit.prevent="ajouterBdeNouveau()">
    ...
    <div class="bloc-modale" v-if="afficherFormulaireBde">
      ...
      <table class="table table-striped table-bordered table-hover" v-if="bdeAvecTravaux.length">
        ...
        <tbody>
          <template v-for="(bde, numRomain) in bdeAvecTravaux" :key="bde.nomTravaux">
            ...
            <tr v-for="(des, numeroDes) in bde.designations" :key="des.CodeDes">
              ...
              <td><span class="badge bg-success" style="font-size: 16px;">{{ formatQte(des.Quantite * des.Pu) }}</span></td>
            </tr>
...
<form @submit.prevent="ajouterBde(numRomain, bde.nomTravaux)">
      ...
      <div class="bloc-modale" v-if="afficherModaleDesignation">
        ...
        <div class="modale card">
            ...
            <h5 style="color: #b1b9b9;">{{ DesignationSelectionner }}</h5>
