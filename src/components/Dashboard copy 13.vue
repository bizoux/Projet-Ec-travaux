...
export default {
  data() {
    return {
      userMessage: "",
      messages: [],
      OPENROUTER_API_KEY: "TA_CLE_OPENROUTER_ICI", // Mets ta clé ici
    };
  },
  methods: {
    async handleSend() {
      ...
      try {
        const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
          method: "POST",
          headers: {
            "Authorization": `Bearer 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`,
