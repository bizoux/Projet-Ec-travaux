...
<!-- État et mode -->
    ...
    <v-expansion-panels>
      <v-expansion-panel>
        ...
        <v-expansion-panel-title style="font-size: 20px;">Nouveau Matériel</v-expansion-panel-title>
      ...
      <form @submit.prevent="modeEdition ? modifierMateriel() : ajouterMateriel()">
          ...
          <div class="mt-4 text-end">
            ...
            <v-btn prepend-icon="mdi-check-circle" variant="elevated" color="primary" class="rounded-xl">{{ modeEdition ? 'Enregistrer' : 'Ajouter' }}</v-btn>&nbsp;
