<template>
  ...
  <v-navigation-drawer
    ...
    @click="rail = false"
  >
  <center><img src="../image/logoDGI.png" alt="" width="70px" class="p-2"></center>
    <v-list-item
      lines="two"
      link
    ...
    <v-list class="py-0" slim>
      ...
      <v-list-item to="/Inscrire" prepend-icon="mdi-home-outline" title="Inscription" exact/>
      ...
      <v-list-item @click="logoutUser" prepend-icon="mdi-logout" title="Déconnexion"/>
