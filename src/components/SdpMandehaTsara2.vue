    ...
    <tbody>
      ...
      <tr v-for="item in sdp.mainOeuvre" :key="'mo-' + item.idTacheM">
        ...
        <td>
          ...
          &nbsp;<button class="btn btn-sm btn-outline-danger" v-on:click="supprimerMainOeuvre(item.idTacheM,item.nom)"><font-awesome-icon icon="pen"/> Supprimer</button>
          </center>
        </td>
      </tr>
    ...
    <div class="bloc-modale" v-if="afficherModaleMainOeuvre">
      ...
      <tr v-for="item in sdp.materiels" :key="'mat-' + item.idTacheMateriel">
        ...
        <td>
          ...
          &nbsp;<button class="btn btn-sm btn-outline-danger" v-on:click="supprimerMateriel(item.idTacheMateriel,item.nom)"><font-awesome-icon icon="pen"/> Supprimer</button>
          </center>
