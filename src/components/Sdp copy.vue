          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="mb-3">
                ...
                <select class="form-control" v-model="selectedDesBde" required>
      
                  <option disabled value="">-- Choisir une designation --</option>
                  <option v-for="desProjet in ListeDesignationProjet" :key="desProjet.Num" :value="desProjet.Num">
           ...
           <div class="row">
             ...
             <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input class="form-control" v-model="unite" placeholder="unité" required/>
                </div>
             </div>
           ...
           <div class="row">
              ...
              <div class="col-md-6">
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control" v-model="dureeJ" placeholder="durée" required/>
...
<h3 style="float: right;font-weight: 700;">
   K1 = {{ formatCoefficient(tacheList[0].coefficientK) }}
</h3>
</div> -->
           ...
           <div class="row">
              ...
              <div class="col-md-6">
                  ...
                  <div class="mb-3">
                    ...
                    <label for="" class="form-label">Durée de la tâche <b style="color: rgb(255, 0, 0);">*</b></label>
                    <input class="form-control" v-model="modifDureeJ" placeholder="durée" required/>
            ...
            <button class="btn btn-primary" v-on:click="ModifierTacheSdp()">Modifier</button>
...
async RecupererTache(idTache,Designation) {
  ...
  // alert(Designation+'  bonjour : '+idTache+' '+tache.idDevis+' '+tache.Num+' '+tache.unite+' '+tache.quantiteR+' '+tache.rendementJ+' '+tache.dureeJ+' '+tache.coefficientK+' '+tache.terminee);
  ...
  const existe = await db.taches
    .where({ 
      ...
      Num: this.selectedDesBde // ou la valeur dynamique de ta tâche
    }).first();
