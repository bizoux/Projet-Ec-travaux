...
<div class="container col-md-3 p-3">
  ...
  <div class="bg-danger text-white p-2 message-box">
    <div
  ...
  <div class="input-area mt-2 d-flex gap-2">
    <input
      v-model="userInput"
...
.message-box {
  border-radius: 6px;
  word-break: break-word;   /* casse les mots trop longs */
  white-space: normal;      /* permet le retour automatique à la ligne */
  overflow: visible;        /* pas de scroll inutile */
  max-height: 400px;        /* optionnel : limite la hauteur */
  overflow-y: auto;         /* ajoute un scroll vertical si beaucoup de messages */
}
...
/* Messages utilisateur et bot différenciés */
.message.user {
  text-align: right;
  font-weight: bold;
  color: #fff;
