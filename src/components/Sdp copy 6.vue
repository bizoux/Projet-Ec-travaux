    ...
    <div class="bloc-modale" v-if="modalModifCompMateriel">
        ...
        <div class="modale card">
          ...
          <div class="mb-3">
            ...
            <select class="form-control" v-model="ModifNomMateriel" @change="PuCorrespondant" required>
...
async RecupererCompPrixMateriel(idTacheMateriel){
  ...
  if (tacheMateriel) {
      ...
      this.ModifPuMateriel = tacheMateriel.qteTotale;
      this.ModifQteTotaleMateriel = tacheMateriel.Pu;
