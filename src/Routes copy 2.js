    ...
    import Madagascar from "./components/Madagascar.vue";
    import Nouveau_projet from "./components/Nouveau_projet.vue";
    import NouveauProjet from "./components/NouveauProjet.vue";
    import Projet_existant from "./components/Projet_existant.vue";
...

        {
            ...
            children: [
                ...
                { 
                    ...
                    { path: '', redirect: to => ({ name: 'Materiel', query: to.query }) }
                ], 
                ...
                { 
                    ...
                    meta:{
                        ...
                        //     { path: 'Madagascar', name: 'Madagascar', component: Madagascar,meta:{requiresAuth: true,title:"Madagascar"}},
                ...
                { 
                    path: '/Nouveau_projet', 
                    name: 'Nouveau_projet', 
                    component: Nouveau_projet,
                    meta:{
                        requiresAuth: true,
                        title:"Nouveau projet / Madagascar"
                    }
                },
                ...
                { 
                    ...
                    name: 'Projet_existant', 
                    component: Projet_existant,
                    meta:{
                            requiresAuth: true,
