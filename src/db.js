...
db.version(16).stores({
  ...
  taches: '++idTache, idProj, Num, unite, quantiteR, rendementJ, dureeJ, coefficientK, terminee',     
  ...
  bde : 'Num,idProj,CodeLot,CodeTrav,Unite,Quantite,Pu,Montant',
  Lot : '++CodeLot,lot',
  Travaux : '++CodeTrav,nomTravau,Description',
